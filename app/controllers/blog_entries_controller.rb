class BlogEntriesController < ApplicationController
  ...
  def show
    @blog_author = @blog_entry.blog.author
    @blog_user = @blog_entry.blog.user.username
    @blog_comments = @blog_entry.blog_comments
    @last_comment = @blog_entry.blog_comments.last.entry_text
    @blog_entry_title = @blog_entry.blog.title
  end
  ...
  private
    ...
    def blog_entry_params
      params.require(:blog_entry).permit(:entry_text, :user_id, :category, :blog_id)
    end
end
