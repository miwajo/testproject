...
class BlogEntriesControllerTest < ActionController::TestCase
  ...
  test "should create blog_entry" do
    assert_difference('BlogEntry.count') do
      post :create, blog_entry: { blog_id: @blog_entry.blog_id, category: @blog_entry.category, entry_text: @blog_entry.entry_text, user_id: @blog_entry.user_id }
    end
  ...
  test "should update blog_entry" do
    patch :update, id: @blog_entry, blog_entry: { blog_id: @blog_entry.blog_id, category: @blog_entry.category, entry_text: @blog_entry.entry_text, user_id: @blog_entry.user_id }
    assert_redirected_to blog_entry_path(assigns(:blog_entry))
  end
